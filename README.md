...
Vercel rewrites `/api/*` to `https://geo-attendance-tracker-36uv.onrender.com/api/*`. If Render gives you a different backend URL, update the rewrite destination in `vercel.json` before redeploying.
